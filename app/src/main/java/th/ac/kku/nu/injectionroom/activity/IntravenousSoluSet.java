...
public class IntravenousSoluSet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intravenous_solu_set);

        purpose_contents = getResources().getStringArray(R.array.intravenous_purpose);
        procedure_contents = getResources().getStringArray(R.array.intravenous_SoluSet_step);
        purpose = (TextView)findViewById(R.id.intravenous_soluSet_purpose);
        procedure = (TextView)findViewById(R.id.intravenous_soluSet_procedure);
